...
function custom_share_buttons()
{
	...
	echo '<a href="' . $linkedin_url . '" target="_blank" class="custom-share-button custom-share-button-linkedin"><i class="share"> ' . get_template_part("/assets/img/svg/share") . '</i></a>';
		...
		<div class="single-blog">
			...
			<div class="post-main">
				...
				<div>
					...
					<h1 id="title"><?= get_the_title($post_id) ?></h1>
				...
				<div class="blog-comments">
					<div class="single-comment-number">
						<h6><span><?= ' ' . get_comments_number($post_id); ?> </span><?= pll__('comment') ?></h6>
					</div>
