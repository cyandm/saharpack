...
<main class="single-product-page">
            ...
            <div class="product-detail">
                ...
                <div class="add-cart">
                    <div class="share-and-add-cart">
                        <a href="<?= $wc_product->add_to_cart_url() ?>" class="btn"
                            variant="primary"><?= pll__('افزودن به سبد خرید') ?></a>
    ...
    <section class="favorite-products container">
        <div class="favorite-products__title-and-btn-all">
            ...
            <a href="<?= $page_product_link ?>" class="btn btn-view-all"
                variant="secondary"><?= pll__('view-all') ?></a>
        </div>
        ...
        <a href="<?= $page_product_link ?>" class="btn btn-view-all__mobile"
            variant="secondary"><?= pll__('view-all') ?></a>
