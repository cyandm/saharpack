            ...
            <div class="product-detail">
                ...
                <div class="product-stock">
                    ...
                    <?php if ($product_stock_status === 'instock') :  ?>
                        <div class="count-inventory"><i><?= get_template_part('assets/img/svg/icon-inventory') ?></i><span><?= pll__('موجود') ?></span></div>
                    <?php else : ?>
                        <div class="count-no-inventory"><i><?= get_template_part('assets/img/svg/icon-no-inventory') ?></i><span><?= pll__('ناموجود') ?></span></div>
                    <?php endif; ?>
                </div>
                <div class="add-cart">
