...
<main class="container mx-auto">
	<div class="woocommerce-order text-center">
		...
		if ($order):
			...
			<?php else: ?>
				<div class="bg-gray-50 p-3 my-6">
					<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received my-6 ">
					...
					<ul
						class="woocommerce-order-overview woocommerce-thankyou-order-details order_details flex justify-center items-center mt-[20px]">
